...
int main(void) {
    ...
    do {
        ...
        choice = get_validated_int(1, 7, "Enter choice (1-7): ", "Invalid choice. Try again.");
        
        
        switch (choice) {
            case 1: int x,y,z;  printf("Enter value, lo, hi: ");   fscanf(stdin, "%d %d %d", &x,&y,&z);    printf("clamp(%d, %d, %d) = %d\n",x,y,z,clamp(x,y,z)); break;
